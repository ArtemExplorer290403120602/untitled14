...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            SystemUser.register(login,password,confirmPassword);
        }catch (WrongLoginException e){
            System.out.println("Некорретно ввели данные: " + e.getMessage());
        }catch (WrongPasswordException e){
            System.out.println("Некорректно ввели данные: " + e.getMessage());
        }
    }
}
